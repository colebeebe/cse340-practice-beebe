  ...
  session({
    store: new pgSession({
      conObject: {
        ...
        // Configure SSL for session store connection (required by BYU-I database)
        ssl: {
          ca: caCert,
...
app.use((err, req, res, next) => {
  ...
  const context = {
    ...
    NODE_ENV, // Our WebSocet check need this and it's convenient to pass along
  };
...
// Start WebSocet server in dev mode (used for live reloading)
